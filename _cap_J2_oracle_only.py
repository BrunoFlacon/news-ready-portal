...
OUT = os.path.join(BASE, "_oracle_alerts_FINAL_J2.out")
...
for l in raw.splitlines():
    ...
    if re.search(r"(Test Files|Tests |PASS|FAIL|passed|failed|ReferenceError"
                 r"|nullapsed|Element type|Cannot read|Cannot find|Syntax Error"
                 r"|Expression expected|expect\(|Received|Unable to find|✓|×)", a):
        print(a[:170]); cnt += 1
    if cnt > 55:
        break
