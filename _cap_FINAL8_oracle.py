# -*- coding: utf-8 -*-
# Oracle vitest FINAL byte-safe (escreve saída em arquivo, imprime só veredito).
# Estado atual: Bell no Home (planned), nullapsed corrigido, caches virados.
import os, re, subprocess, time

BASE = "C:/wamp64/www/news-ready-portal/opencode/news-ready-portal"
OUT = os.path.join(BASE, "_oracle_alerts_FINAL8.out")
...
for l in raw.splitlines():
    ...
    if re.search(r"(Test Files|Tests |PASS|FAIL|passed|failed|ReferenceError"
                 r"|nullapsed|Element type|Cannot read|Unable to find|Syntax Error"
                 r"|toHaveTextContent|Bell is|player-breaking|player-alert|✓|×)", a):
        print(a[:170])
