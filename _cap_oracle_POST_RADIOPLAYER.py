# -*- coding: utf-8 -*-
# Oracle vitest FINAL POS-FIX 4.2b - veredito byte-safe
import os, re, subprocess, time

BASE = "C:/wamp64/www/news-ready-portal/opencode/news-ready-portal"
OUT = os.path.join(BASE, "_oracle_alerts_POST_RADIOPLAYER.out")
...
for l in raw.splitlines():
    ...
    if re.search(r"(Test Files|Tests |PASS|FAIL|passed|failed|ReferenceError"
                 r"|Element type|got: undefined|Cannot read|Unable to find"
                 r"|player-breaking-bar|player-alert-mute|✓|×)", a):
        print(a[:170])